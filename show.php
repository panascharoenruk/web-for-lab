...
?>
  <tr>
    ...
    <td><a href='edit.php?id="<?php echo $Result['id']; ?>' class="btn btn-light text-center">Edit</a></td>
    <td><a href='delete.php?id=<?php echo $Result['id']; ?>' class="btn btn-light text-center">Delete</a></td>
  </tr>
</div>
<?php
}
