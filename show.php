...
?>
  <tr>
    ...
    <td style="text-align: center;"><a href='edit.php?id="<?php echo $Result['id']; ?>'>Edit</a></td>
    <td style="text-align: center;"><a href='delete.php?id=<?php echo $Result['id']; ?>'>Delete</a></td>
  </tr>
</div>
<?php
}
