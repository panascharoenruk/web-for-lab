...
?>
  <tr>
    ...
    <td>
      <a href="edit.php?id=<?php $data['ID']; ?>" type="submit" id="commentBtn" class="btn btn-primary"></a>
      <a href="delete.php?id=<?php $data['ID']; ?>" type="submit" id="commentBtn" class="btn btn-primary"></a>
